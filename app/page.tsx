    ...
    <>
      <div className="h-full ">
        ...
        <div className="bg-gradient-to-b from-black/50 to-black/10 backdrop-blur-[2px] h-[4rem] flex items-center">
          <header className="mx-auto w-full max-w-7xl px-4 md:px-6 lg:px-8 flex items-center justify-between pt-4 md:pt-10 gap-2">
            <div>
        ...
        {/* height 4rem */}
        <div className=" backdrop-blur-[2px] h-[4rem] flex items-center mt-10">
